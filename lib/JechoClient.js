...
var JechoClient = {
  ...
  wsSend: function(type, data) {
    ...
    var msg = { id: this.nMessages, type: type, data: (typeof data == 'undefined' ? 'JS UNDEFINED' : ( data === null ? 'JS NULL' : data ) ) };
  ...
  xhrSend: function( type, data ) {
    ...
    xhr.send( JSON.stringify( { id: this.nMessages, type: type, data: data } ) );
  },
